...
active-view@0.0.4 minified file: [active-view.min.js](https://github.com/forceuser/active-view/releases/download/0.0.4/active-view.min.js)

#### Or just load from CDN

```html
<script src="//cdn.rawgit.com/forceuser/active-view/0.0.4/dist/active-view.min.js">
</script>
```
